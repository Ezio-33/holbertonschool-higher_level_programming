...
def matrix_divided(matrix, div):
    ...
    Return:
    list de listes de float: Une nouvelle matrice avec les éléments divisés par le diviseur.

    Raises: :  TypeError: Si la matrice n'est pas une liste de listes d'entiers ou de flottants,
